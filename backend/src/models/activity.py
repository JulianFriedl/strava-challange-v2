...
class GeoJSONLineString:
    ...
    def from_mongo(cls, data):
        """Convert MongoDB data to GeoJSONLineString instance."""
        return cls(
            type=data["type"],
    ...
    def to_mongo(self):
        """Convert GeoJSONLineString instance to a MongoDB-compatible dictionary."""
        return {
            "type": self.type,
...
class Activity:
    ...
    def from_mongo(cls, data):
        ...
        return cls(
            ...
            polyline=GeoJSONLineString.from_mongo(data["summary_polyline"]),
            kudos=data["kudos"],
